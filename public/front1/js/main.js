...
(function ($) {
    ...
    function categoryMenu() {
        ...
        if (winWidth < 992) {
            ...
            $(".catmenu-body")
                .find(".catmenu-megamenu")
                .removeClass("catmenu-megamenu");
            $(".catmenu-body")
                .find(".catmenu-dropdown")
    ...
    function recommendedExerpt() {
        var max = 75;
        var tot, str;
        $(".recommended-products-slider .hoproduct-4 .hoproduct-title").each(
            function () {
    ...
    $(".checkout-info-login-trigger, .checkout-info-coupon-trigger").on(
        "click",
        function (e) {
            e.preventDefault();
            $(this)
                .parent(".checkout-info")
                .next(".checkout-info-collapsebox")
                .slideToggle();
        }
    );
