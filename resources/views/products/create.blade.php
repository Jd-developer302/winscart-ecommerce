    ...
    <div class="card-body">
        <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea value="{{ old('description') }}" type="text" class="form-control" id="content1" name="description"
            ...
            <div class="mb-3">
                ...
                <textarea value="{{ old('description') }}" type="text" class="form-control" id="content" name="specification"
                    placeholder="Specification">{{ old('specifications') }}</textarea>
