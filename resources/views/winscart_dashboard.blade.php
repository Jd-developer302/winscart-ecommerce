    ...
    <div>
        <ol class="breadcrumb">
            ...
            <div id="reportrange" style="background: #fff; cursor: pointer; padding: 5px 10px; color:#000; border: 1px solid #ccc; width: 100%">
                ...
                <span>{{ $date }}</span> <i class="fa-solid fa-caret-down"></i>
            </div>
                    ...
                    <div class="card-body ">
                        <div class="d-flex">
                            <div class="mt-2">
                                ...
                                <h2 style="font-size: 14px;font-weight:600;">{{ $totalOrders }}</h2>
                            </div>
                            <div class="ms-auto">
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="mt-2">
                                ...
                                <h2 style="font-size: 14px;font-weight:600;">{{$totalCancelledOrders}}</h2>
                            </div>
                            <div class="ms-auto">
                                <div class="chart-wrapper mt-1">
                                    <canvas id="costchart"
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="mt-2">
                                <h6 style="font-size: 14px; font-weight: 400;">{{ $order['status'] }}</h6>
                                <h2 style="font-size: 14px; font-weight: 600;">{{ $order['count'] }}</h2>
                            </div>
                        ...
                        <span class="text-muted fs-12"><span class="text-warning"><i
                                    class="fe fe-arrow-up-circle text-warning"></i> {{ $order['percentage'] }}%</span>
                            Today</span>
                            ...
                            const chart = new Chart(ctx, {
                                ...
                                data: {
                                    ...
                                    datasets: [
                                        ...
                                        {
                                            label: 'Order Trend',
                                            data: @json($delivered->merge($cancelled)),
                                            borderColor: '#fff',
                ...
                <div class="card-body">
                    <div class="d-flex mb-4 mt-3">
                        ...
                        <div class="">
                            ...
                            <p class="fw-normal fs-12"> <span class="text-success">{{ $deliveredIncrease }}%</span>
                                increased </p>
                        </div>
                        <div class=" ms-auto my-auto">
                            <p class="fw-bold fs-20"> {{ number_format($totalDelivered) }} </p>
                        </div>
                    </div>
                    <div class="d-flex">
                        ...
                        <div class="">
                            ...
                            <p class="fw-normal fs-12"> <span class="text-success">{{ $cancelledIncrease }}%</span>
                                increased </p>
                        </div>
                        <div class=" ms-auto my-auto">
                            <p class="fw-bold fs-20 mb-0"> {{ number_format($totalCancelled) }} </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="comment-widgets scrollable">
                        ...
                        <div class="d-flex flex-row comment-row m-t-0">
                            <div class="p-2"><img src="{{ url('assets/images/users/1.jpg') }}" alt="user"
...
<div class="d-flex flex-row comment-row">
    <div class="p-2"><img src="{{ url('assets/images/users/4.jpg') }}" alt="user"
...
<!-- Comment Row -->
<div class="d-flex flex-row comment-row">
    <div class="p-2"><img src="{{ url('assets/images/users/5.jpg') }}" alt="user"
            width="50" class="rounded-circle"></div>
    <div class="comment-text w-100">
                ...
                <li class="list-group-item todo-item" data-role="task">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label todo-label" for="customCheck">
                            <span class="todo-desc">Lorem Ipsum is simply dummy text of the printing and
                    ...
                    <ul class="list-style-none assignedto">
                        <li class="assignee"><img class="rounded-circle" width="40"
                                src="{{ url('assets/images/users/1.jpg') }}" alt="user"
                                data-toggle="tooltip" data-placement="top" title=""
                                data-original-title="Steave"></li>
                        <li class="assignee"><img class="rounded-circle" width="40"
                                src="{{ url('assets/images/users/2.jpg') }}" alt="user"
                                data-toggle="tooltip" data-placement="top" title=""
                                data-original-title="Jessica"></li>
                        <li class="assignee"><img class="rounded-circle" width="40"
                                src="{{ url('assets/images/users/3.jpg') }}" alt="user"
                                data-toggle="tooltip" data-placement="top" title=""
                                data-original-title="Priyanka"></li>
                        <li class="assignee"><img class="rounded-circle" width="40"
                                src="{{ url('assets/images/users/4.jpg') }}" alt="user"
                                data-toggle="tooltip" data-placement="top" title=""
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label todo-label" for="customCheck1">
                            <span class="todo-desc">Lorem Ipsum is simply dummy text of the
                                printing</span><span class="badge badge-pill badge-primary float-right">1
                                week </span>
                        </label>
                    </div>
                ...
                <li class="list-group-item todo-item" data-role="task">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label todo-label" for="customCheck3">
                            ...
                            </span> <span class="badge badge-pill badge-warning float-right">2 weeks</span>
                        </label>
                    </div>
                    <div class="item-date"> 26 jun 2017</div>
                </li>
        ...
        <div class="card-body">
            ...
            <div class="chat-box scrollable" style="height:475px;">
                ...
                <ul class="chat-list">
                    <!--chat Row -->
                    <li class="chat-item">
                        <div class="chat-img"><img src="{{ url('assets/images/users/1.jpg') }}"
                                alt="user"></div>
                    ...
                    <!--chat Row -->
                    <li class="chat-item">
                        <div class="chat-img"><img src="{{ url('assets/images/users/2.jpg') }}"
                                alt="user"></div>
                        <div class="chat-content">
                    ...
                    <!--chat Row -->
                    <li class="chat-item">
                        <div class="chat-img"><img src="{{ url('assets/images/users/3.jpg') }}"
                                alt="user"></div>
                        <div class="chat-content">
        ...
        <div class="tab-content tabcontent-border">
            <div class="tab-pane active" id="home" role="tabpanel">
                <div class="p-20">
                    ...
                    <img src="{{ url('assets/images/background/img4.jpg') }}" class="img-fluid">
                </div>
            </div>
            <div class="tab-pane  p-20" id="profile" role="tabpanel">
                <div class="p-20">
                    <img src="{{ url('assets/images/background/img4.jpg') }}" class="img-fluid">
                    <p class="m-t-10">And is full of waffle to It has multiple paragraphs and is full of waffle
